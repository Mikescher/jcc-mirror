...
export const configPages: readonly ConfigPage[] = [
  ...
  },
  {
    ...
    label: 'System',
    blurb:
      'How long history is kept, the zone every timestamp is written in, the password this dashboard asks for, the key of the read-only remote API, and the daemon log. Every setting lives in the database, takes effect the moment it is saved, and is recorded under Audit.',
    groups: ['Retention', 'General', 'Dashboard', 'Remote API'],
  },
  {
    path: 'audit',
    label: 'Audit',
